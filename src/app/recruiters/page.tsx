...
export default function Recruiters() {
    return (
        <div className="min-h-screen bg-bg-cream flex flex-col items-center justify-center p-6">
            <div className="bg-neo-yellow neo-border p-10 max-w-2xl w-full neo-shadow-lg text-center relative overflow-hidden text-black">
                <div className="absolute -top-10 -right-10 w-32 h-32 bg-white rounded-full opacity-20" />
                <Briefcase className="w-16 h-16 mx-auto mb-6 text-black" />
                <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-4 text-black">Recruiter Tools</h1>
                ...
                <div className="text-left space-y-4 mb-10 bg-white p-6 neo-border text-black">
                    <p className="font-medium text-black">This is a placeholder for the B2B recruiter shortlist dashboard.</p>
                </div>
