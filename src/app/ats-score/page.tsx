...
export default function AtsScore() {
    return (
        <div className="min-h-screen bg-bg-cream flex flex-col items-center pt-28 pb-16 px-4 sm:px-6">
            <div className="max-w-4xl w-full text-center mb-12">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter mb-4">ATS Score Check</h1>
