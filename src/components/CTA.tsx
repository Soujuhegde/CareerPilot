...
export default function CTA() {
    return (
        <section className="py-16 sm:py-24 relative z-20 px-4 sm:px-6 bg-bg-cream pb-20 sm:pb-32">
            <motion.div
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="max-w-5xl mx-auto bg-neo-yellow neo-border neo-shadow-lg p-8 sm:p-12 md:p-20 lg:p-24 text-center relative overflow-hidden"
            >
                {/* Decorative Elements */}
                ...
                <div className="relative z-20 max-w-3xl mx-auto flex flex-col items-center">
                    <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-[72px] font-black text-black mb-6 leading-tight tracking-tighter uppercase relative">
                        Ready to Upgrade <br />
                    ...
                    <div className="flex items-center justify-center gap-6 mt-4 relative z-30">
                        <Link href="/signup" className="px-6 sm:px-10 py-4 sm:py-5 bg-black text-white font-black uppercase tracking-widest text-base sm:text-lg md:text-xl neo-border neo-shadow-hover hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-200 text-center">
                            Create Free Account
                        </Link>
                    </div>
